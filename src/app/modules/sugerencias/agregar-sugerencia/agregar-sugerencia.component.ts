...
export class AgregarSugerenciaComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public editarDatos: any, public dialogRef: MatDialogRef<AgregarSugerenciaComponent>) {
  }
  ...
  ngOnInit(): void {
    ...
    if (this.editarDatos) {
      this.isEdit = true;
      this.ingresarSugerencia.controls['titulo'].setValue(this.editarDatos.nombreLibro),
        this.ingresarSugerencia.controls['isbn'].setValue(this.editarDatos.isbn),
        this.ingresarSugerencia.controls['autor'].setValue(this.editarDatos.autor),
        this.ingresarSugerencia.controls['fecha'].setValue(new Date(this.editarDatos.fecha)),
        this.ingresarSugerencia.controls['ci_solicitante'].setValue(this.editarDatos.ci_solicitante)
      return;
    }
    this.isEdit = false;
  }
